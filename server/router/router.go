...
func SetupRouter() *gin.Engine {
	...
	router.GET("/customers/:id/paymentmethods", controller.GetCustomerPaymentMethods)
	router.GET("/customers/:id/paymentmethods/count", controller.GetCustomerPaymentMethodsCount)
